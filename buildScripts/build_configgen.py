...
src_path = os.path.join(script_path, r'../Assets/Scripts/'.replace('/', sep_char))
temp_folder = os.path.join(script_path, r'temp')
codegen_exe_out = os.path.join(script_path, r'temp/codegen.exe')
codegen_gencode_out = os.path.join(script_path, r'../Assets/GeneratedCode')
...
if __name__ == '__main__':
	try:
		...
		result = list_src_files(src_path, excludes)
		result += list_src_files(codegen_temp_out, None, "../../build/temp/codegen")
		print(result)
